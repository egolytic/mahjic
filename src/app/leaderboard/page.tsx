...
function getTierColor(rating: number): string {
  ...
  if (rating >= RATING_TIERS.INTERMEDIATE.min) return 'text-green-600 bg-green-50';
  if (rating >= RATING_TIERS.BEGINNER.min) return 'text-yellow-600 bg-yellow-50';
    ...
    <div className="min-h-screen bg-[#faf8f3]">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {displayPlayers.map((player, index) => (
                  <tr key={player.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Link href={`/players/${player.id}`} className="group">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-sm font-semibold text-gray-900 group-hover:text-[#2d5a4a] transition-colors">
                              {player.name}
                            </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-lg font-bold text-gray-900">{player.verified_rating}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="mt-8 bg-white rounded-xl border border-gray-200 p-6">
          <h3 className="font-semibold text-gray-900 mb-2">About the Leaderboard</h3>
